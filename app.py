...
def user_input_features():
    components_co = st.sidebar.number_input("CO (ppm)", 0.0, 10.0, 5.0)
    components_no = st.sidebar.number_input("NO (ppm)", 0.0, 10.0, 5.0)
    components_no2 = st.sidebar.number_input("NO2 (ppm)", 0.0, 10.0, 5.0)
    components_o3 = st.sidebar.number_input("O3 (ppm)", 0.0, 10.0, 5.0)
    components_so2 = st.sidebar.number_input("SO2 (ppm)", 0.0, 10.0, 5.0)
    ...
    components_nh3 = st.sidebar.number_input("NH3 (ppm)", 0.0, 10.0, 5.0)
