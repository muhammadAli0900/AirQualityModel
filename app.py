...
def user_input_features():
    components_co = st.sidebar.number_input("CO (ppm)", 0.0, 15000.0, 2000.0)
    components_no = st.sidebar.number_input("NO (ppm)", 0.0, 310.0, 20.0)
    components_no2 = st.sidebar.number_input("NO2 (ppm)", 0.0, 310.0, 20.0)
    components_o3 = st.sidebar.number_input("O3 (ppm)", 0.0, 310.0, 50.0)
    components_so2 = st.sidebar.number_input("SO2 (ppm)", 0.0, 170.0, 20.0)
    components_pm2_5 = st.sidebar.number_input("PM2.5 (µg/m³)", 0.0, 1200.0, 50.0)
    components_pm10 = st.sidebar.number_input("PM10 (µg/m³)", 0.0, 1300.0, 50.0)
    components_nh3 = st.sidebar.number_input("NH3 (ppm)", 0.0, 180.0, 25.0)
    ...
    surface_pressure = st.sidebar.number_input("Surface Pressure (hPa)", 825.0, 1025.0, 1013.0)
    wind_speed_10m = st.sidebar.number_input("Wind Speed (m/s)", 0.0, 50.0, 10.0)
